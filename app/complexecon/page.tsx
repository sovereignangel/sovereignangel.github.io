          ...
          <div className="mt-1.5 flex flex-wrap items-center gap-x-3 gap-y-1">
            {item.readerUrl && (
              <button
                ...
                className="rounded-sm border border-burgundy bg-burgundy px-2 py-0.5 font-serif text-[10px] font-medium text-paper transition-colors hover:bg-burgundy/90"
              >
            ...
            {item.sources.map(s => (
              <a
                ...
                className="font-mono text-[9px] uppercase tracking-[0.5px] text-ink-muted underline decoration-rule underline-offset-2 transition-colors hover:text-burgundy hover:decoration-burgundy/40"
              >
            ...
            <button
              ...
              className={`ml-auto rounded-sm border px-2 py-0.5 font-serif text-[10px] font-medium transition-colors ${
                memoOpen
              ...
              {signedIn ? (
                <>
                  <textarea
                    ...
                    className="w-full rounded-sm border border-rule bg-paper px-2.5 py-2 font-serif text-[12px] leading-relaxed text-ink placeholder:text-ink-faint focus:border-ink-faint focus:outline-none"
                  />
                  <div className="mt-1 flex items-center justify-between">
                    <span className="font-mono text-[8px] uppercase tracking-[1px] text-ink-faint">
                ...
                <div className="flex items-center gap-3 py-1">
                  <span className="text-[11px] text-ink-muted">Sign in to keep memos on this book.</span>
                  <button
                    onClick={onSignIn}
                    className="rounded-sm border border-burgundy bg-burgundy px-2.5 py-1 font-serif text-[10px] font-medium text-paper hover:bg-burgundy/90"
                  >
                    Sign in with Google
                  </button>
                </div>
