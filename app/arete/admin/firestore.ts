...
export async function seedDefaults() {
  ...
  const baseSeeds: Seed[] = [
    ...
    { name: 'French tutor', amount: 1600 * 4, category: 'tutor', weeks: allWeeks, notes: 'One tutor for the full month, joining the daily lesson over Zoom. $1,600/week.', charged: false },
