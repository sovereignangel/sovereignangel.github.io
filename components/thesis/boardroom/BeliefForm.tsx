    ...
    <form onSubmit={handleSubmit} className="bg-paper border border-rule rounded-sm p-3 space-y-2">
      <div>
        ...
        <textarea
          ...
          className="w-full h-16 bg-white border border-rule rounded-sm p-2 text-[11px] text-ink resize-y focus:outline-none focus:border-burgundy"
          autoFocus
        />
      </div>
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <select
            ...
            className="bg-white border border-rule rounded-sm px-1.5 py-1 text-[10px] text-ink focus:outline-none focus:border-burgundy"
          >
            {DOMAINS.map(d => (
      ...
      <div>
        ...
        <textarea
          ...
          className="w-full h-12 bg-white border border-rule rounded-sm p-2 text-[10px] text-ink resize-y focus:outline-none focus:border-burgundy"
        />
      </div>
