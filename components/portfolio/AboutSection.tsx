  ...
  return (
    <section className="bg-[#faf8f4]/30 backdrop-blur-sm rounded-sm p-5 -mx-5 font-serif">
      ...
      <p className="text-[#333] mb-4">
        I&apos;m the technology partner for emerging hedge fund investors.
      </p>
      <p className="text-[#333] mb-4">
      ...
      <div className="flex items-center gap-5 text-[#333]" aria-label="Sports">
        ...
        >
          <span className="absolute -top-[6px] -left-[1px] px-1 bg-[#faf8f4] leading-none" aria-hidden="true">
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img src="/ironman-logo.png" alt="" className="h-[11px] w-auto" />
          </span>
          <svg
            width="28"
            height="28"
