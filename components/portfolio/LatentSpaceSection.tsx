...
function Section({ title, number, children }: { title: string; number?: string; children: React.ReactNode }) {
  return (
    <div style={{ position: 'relative', padding: '48px 40px 40px', borderBottom: `1px solid ${RULE}` }}>
      {number && (
        <div style={{ ...monoText('11px'), textTransform: 'uppercase' as const, letterSpacing: '0.15em', marginBottom: 8, color: GOLD }}>
          {number}
        </div>
      )}
      <h3 style={{ ...codexText('28px', 600), marginBottom: 24, lineHeight: 1.2 }}>{title}</h3>
...
export default function LatentSpaceSection() {
  ...
  return (
    <section className="mt-4">
      ...
      <div style={{ background: CREAM, maxWidth: 720, margin: '0 auto', position: 'relative', overflow: 'hidden' }}>
        {/* Cover */}
        <div style={{ padding: '60px 40px 48px', borderBottom: `2px solid ${INK}`, position: 'relative' }}>
          <GoldenSpiral size={260} style={{ position: 'absolute', right: 20, top: 20 }} />
          <NeuralSketch style={{ position: 'absolute', right: 40, top: 120 }} />

          <div style={{ ...monoText('10px'), textTransform: 'uppercase', letterSpacing: '0.2em', marginBottom: 28, color: GOLD }}>
            Brand Strategy &middot; Confidential &middot; March 2026
          </div>

          <h2 style={{ fontFamily: '"Cormorant Garamond", Georgia, serif', fontSize: '48px', fontWeight: 700, color: SEPIA, lineHeight: 1.05, marginBottom: 14, letterSpacing: '-0.01em' }}>
            Latent Space
          </h2>

          <div style={{ ...codexText('18px'), fontStyle: 'italic', color: FADED_INK, maxWidth: 400, lineHeight: 1.5, marginBottom: 28 }}>
            A frontier AI research dinner series<br />&amp; intellectual community
          </div>

          <div style={{ width: 60, height: 1, background: GOLD, marginBottom: 18 }} />
          ...
          <div>
            ...
            <Section number="03 &middot; Influences" title="Design lineage">
              <div style={{ marginBottom: 16 }}>
                ...
                <p>Newsletter + podcast + immersive scenario games hosted in NYC offices. Content that explores risk, decision-making, and the intersections of science, technology, finance, and the human condition. The editorial voice is intellectually serious but not academic.</p>
              </div>
              <div style={{ marginBottom: 16 }}>
                <div style={{ ...codexText('14px', 600), color: GOLD, marginBottom: 4 }}>Leonardo&apos;s Codex Atlanticus</div>
                <p>1,119 pages of drawings and writing spanning forty years &mdash; the largest extant collection of Leonardo&apos;s investigations across math, science, art, engineering, and the humanities. Not organized by discipline but by the flow of thought.</p>
              </div>
              <div>
                <div style={{ ...codexText('14px', 600), color: GOLD, marginBottom: 4 }}>MaiTai Global / Summit Series</div>
                <p>Proof that adventure-driven community building works at scale. The brand is the attendee list, not the logo. Curation quality over marketing polish.</p>
              </div>
            </Section>
          </div>
        )}
        ...
        {activeTab === 'system' && (
          <div>
            <Section number="06 &middot; Palette" title="Color system">
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
                <div>
                  ...
                  <ColorSwatch name="Parchment" hex="#F5EDD6" annotation="Primary background" />
                  <ColorSwatch name="Iron gall" hex="#2C1810" annotation="Display type" />
                  <ColorSwatch name="Bistre wash" hex="#6B5744" annotation="Secondary text" />
                  <ColorSwatch name="Red chalk" hex="#8B0000" annotation="Accent" />
                </div>
                <div>
                  ...
                  <ColorSwatch name="Gold leaf" hex="#B8860B" annotation="Section marks" />
                  <ColorSwatch name="Light gold" hex="#D4A843" annotation="Subheads on dark" />
                  <ColorSwatch name="Rule" hex="#C4B08E" annotation="Dividers, borders" />
                  <ColorSwatch name="Deep ground" hex="#3D2B1F" annotation="Dark panels" />
                </div>
              </div>
            </Section>
            ...
            <Section number="07 &middot; Typography" title="Type system">
              ...
              <TypeSample label="Annotation &middot; Cormorant Garamond Italic" fontStyle={{ fontFamily: '"Cormorant Garamond", Georgia, serif', fontSize: 14, fontWeight: 400, fontStyle: 'italic', color: FADED_INK, lineHeight: 1.6 }} sample="cf. Codex Atlanticus f. 283v — the earliest known diagram of a self-sustaining feedback mechanism" />
            </Section>

            <Section number="08 &middot; Texture" title="The codex layer">
              <p style={{ marginBottom: 20 }}>
                Every touchpoint carries a subtle codex texture &mdash; the feeling that you&apos;re looking at a page from a living notebook. This is not decoration.
              </p>
        ...
        {activeTab === 'touchpoints' && (
          <div>
            <Section number="09 &middot; Invitation" title="The invitation as artifact">
              <p style={{ marginBottom: 20 }}>
                The invitation is the brand&apos;s first and most important touchpoint. It should feel like receiving a page torn from a private notebook &mdash; something you would keep, not discard.
              </p>
            ...
            <Section number="10 &middot; Post-event" title="The dispatch">
              <p style={{ marginBottom: 20 }}>
                After each dinner, a one-page &ldquo;dispatch&rdquo; is sent to attendees only &mdash; a distillation of the evening&apos;s key ideas, written in the codex register. Not a summary. Not a recap. A notebook entry.
              </p>
              <p style={{ marginBottom: 20 }}>
            ...
            <Section number="11 &middot; Extension" title="Adventure series">
              <p style={{ marginBottom: 20 }}>
                The adventure extension inherits the brand register but shifts the physical context. The codex travels. The intellectual seriousness remains; the setting becomes the shared challenge.
              </p>
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16, marginTop: 20 }}>
                {[
                  { title: 'Kiteboarding + AI', location: 'Cabarete or Aruba', note: 'Morning sessions on the water, afternoon research presentations, evening dinner. The MaiTai model, calibrated for AI research depth.' },
        ...
        {activeTab === 'voice' && (
          <div>
            <Section number="12 &middot; Tone" title="The voice of the codex">
              <p style={{ marginBottom: 20 }}>
                The brand voice is a specific blend: Lux Capital&apos;s editorial confidence meets the Renaissance scholar&apos;s precision meets the warmth of a handwritten invitation.
              </p>
              <div style={{ display: 'grid', gap: 16, marginTop: 20 }}>
                {[
                  ...
                  { principle: 'Warm, never casual', example: '"We look forward to your company at the table." — not — "Can\'t wait to see you there!"' },
            ...
            <Section number="14 &middot; Principles" title="Brand operating rules">
              <div style={{ display: 'grid', gap: 20, marginTop: 8 }}>
                {[
                  { num: 'I', title: 'The brand is the attendee list', body: 'No amount of design compensates for a mediocre room. Curate ruthlessly.' },
                  { num: 'II', title: 'No logo until the third dinner', body: 'The mark is earned by the community, not designed in advance.' },
                  { num: 'III', title: 'Every touchpoint is a notebook page', body: 'Each should feel like it was written by hand, even when it wasn\'t.' },
                  { num: 'IV', title: 'Exclusivity through quality, not scarcity', body: 'The dinner is small because depth requires intimacy, not because exclusion is the point.' },
                  { num: 'V', title: 'The codex accumulates', body: 'Every dinner adds a folio. The dispatches become an archive. A modern codex.' },
                ].map((item) => (
        ...
        {/* Footer */}
        <div style={{ padding: '32px 40px', textAlign: 'center', borderTop: `1px solid ${RULE}` }}>
