...
export const PROPOSAL_PHASES: ProposalPhase[] = [
  {
    id: 'phase-1',
    phase: 1,
    title: 'Tech Build & Investment Diligence',
    ...
    workingRhythm: [
      'Sean screens 2x/week at 2-3 hrs — surfaces ~15 stocks from 2,700 universe',
    ...
    valueMap: [
      ...
      {
        dimension: 'Ticker Coverage',
        current: '~15 stocks surfaced per session',
        withTech: '2,700 stocks ranked daily',
        freed: '180x more candidates',
        impact: 'More trade opportunities = higher dividend capture volume',
      },
      {
    ...
    seanCommitment: 'Domain knowledge transfer, strategy documentation, weekly tech review call, historical trade data access',
    financialTerms: 'Sean allocates capital from the fund for Lori, distributed on agreed technology milestones',
  ...
  },
  {
    ...
    subtitle: 'Leverage tech-proven workflow savings to accelerate AUM growth',
    status: 'future',
    timeline: 'Months 4-8',
    description:
