...
export const SPRINT_ITEMS: SprintItem[] = [
  // ── AGENTS & AUTOMATION (Phase 1 — Sprint) ──
  {
    id: 'sprint-daily-screening',
    title: 'Daily Screening Agent',
    description: 'Runs every morning before market open. Filters 2,700 stocks, ranks dividend candidates, pushes shortlist via text or email. No manual Fidelity session.',
    type: 'feature',
    status: 'sprint',
    owner: 'lori',
    priority: 'high',
  ...
  {
    id: 'sprint-recordkeeping',
    title: 'Recordkeeping Agent',
    description: 'Watches for trade confirmations, auto-logs every buy/sell/dividend event into your tracking system in real time. Ends the spreadsheet grind.',
    type: 'feature',
    status: 'sprint',
    owner: 'lori',
    priority: 'high',
  ...
  {
    id: 'sprint-nosedive-alert',
    title: 'Nosedive Alert Agent',
    description: 'On ex-dividend morning, scores each candidate\'s crash risk and sends a go/no-go signal before you place orders.',
    type: 'feature',
    status: 'sprint',
    owner: 'lori',
    priority: 'high',
  ...
  {
    id: 'sprint-corporate-action',
    title: 'Corporate Action Agent',
    description: 'Auto-detects stock splits, special dividends, and spin-offs that distort historical data — the manual Google/ChatGPT check you\'re doing now, automated.',
    type: 'feature',
    status: 'sprint',
    owner: 'lori',
    priority: 'high',
  ...
  {
    id: 'sprint-foreign-withholding',
    title: 'Foreign Withholding Agent',
    description: 'Before you buy a Canadian or foreign stock, flags the exact withholding rate and calculates your true net dividend — no surprises on payment day.',
    type: 'feature',
    status: 'sprint',
    owner: 'lori',
    priority: 'medium',
  ...
  {
    id: 'sprint-position-monitor',
    title: 'Position Monitor Agent',
    description: 'Watches open positions daily. If a holding starts showing early crash signals before ex-dividend date, it alerts you before damage is done.',
    type: 'feature',
    status: 'sprint',
    owner: 'lori',
    priority: 'high',
  ...
  {
    id: 'sprint-historical-db',
    title: 'Historical Ex-Dividend Database',
    description: '3+ years of price behavior per stock, nosedive risk scoring across last 12 dividend cycles with market vs. stock-specific attribution.',
    type: 'feature',
    status: 'sprint',
    owner: 'lori',
    priority: 'high',
  ...
  // ── RISK & ANALYSIS (Backlog) ──
  {
    id: 'backlog-market-context',
    title: 'Market Context Overlay',
    description: 'When a nosedive is flagged, cross-references VIX, S&P movement, sector conditions on that date. Distinguishes stock-specific risk from market-wide events.',
    type: 'feature',
    status: 'backlog',
    owner: 'lori',
    priority: 'medium',
  ...
  {
    id: 'backlog-recovery-classifier',
    title: 'Recovery Pattern Classifier',
    description: 'Groups stocks by how they historically recover post-ex-dividend: fast bouncers, slow climbers, and chronic underperformers. Improves hold/sell decisions.',
    type: 'feature',
    status: 'backlog',
    owner: 'lori',
    priority: 'medium',
  ...
  {
    id: 'backlog-dividend-sustainability',
    title: 'Dividend Sustainability Scorer',
    description: 'Flags stocks where dividend yield looks attractive but payout ratio, cash flow, or debt levels suggest the dividend may be at risk of a cut.',
    type: 'feature',
    status: 'backlog',
    owner: 'lori',
    priority: 'medium',
  ...
  {
    id: 'backlog-macro-regime',
    title: 'Macro Regime Detector',
    description: 'Identifies whether the current rate environment, sector rotation, or macro backdrop is favorable or unfavorable for dividend capture — adjusts scoring accordingly.',
    type: 'feature',
    status: 'backlog',
    owner: 'lori',
    priority: 'medium',
  ...
  {
    id: 'backlog-treasury-correlation',
    title: 'Treasury Bond Correlation Tracker',
    description: 'Monitors how your T-bond collateral position moves relative to your equity exposure. Flags margin risk before it becomes a problem.',
    type: 'feature',
    status: 'backlog',
    owner: 'lori',
    priority: 'medium',
  ...
  {
    id: 'backlog-liquidity-risk',
    title: 'Liquidity Risk Scorer',
    description: 'Flags thinly traded stocks where your position size could move the market on exit — important as AUM scales.',
    type: 'feature',
    status: 'backlog',
    owner: 'lori',
    priority: 'medium',
  ...
  {
    id: 'backlog-intl-exchange',
    title: 'International Exchange Scout',
    description: 'Scans Scandinavian, Dutch, and other stable international exchanges for dividend capture candidates. Models withholding tax impact by country.',
    type: 'feature',
    status: 'backlog',
    owner: 'lori',
    priority: 'low',
  ...
  {
    id: 'backlog-dividend-arbitrage',
    title: 'Dividend Arbitrage Finder',
    description: 'Looks for the same underlying exposure trading at different yields across exchanges or vehicle types — surfaces mispricing opportunities.',
    type: 'feature',
    status: 'backlog',
    owner: 'lori',
    priority: 'low',
  ...
  {
    id: 'backlog-earnings-proximity',
    title: 'Earnings Proximity Filter',
    description: 'Flags stocks where an upcoming earnings release overlaps with an ex-dividend window — higher risk of outsized move in either direction.',
    type: 'feature',
    status: 'backlog',
    owner: 'lori',
    priority: 'low',
  ...
  {
    id: 'backlog-news-sentiment',
    title: 'News Sentiment Overlay',
    description: 'For flagged candidates, pulls recent news and earnings call sentiment to add qualitative context to the quantitative risk score.',
    type: 'feature',
    status: 'backlog',
    owner: 'lori',
    priority: 'low',
  ...
  {
    id: 'backlog-strategy-memo',
    title: 'AI Strategy Memo Generator',
    description: 'A structured weekly memo that synthesizes screening results, open positions, macro conditions, and flags new research directions — all from actual data.',
    type: 'feature',
    status: 'backlog',
    owner: 'lori',
    priority: 'low',
  ...
  {
    id: 'backlog-paper-trading',
    title: 'Paper Trading Simulator',
    description: 'Runs your strategy on live data with no real capital. Lets you test new models, thresholds, or stock universes before committing money.',
    type: 'feature',
    status: 'backlog',
    owner: 'lori',
    priority: 'low',
  ...
  {
    id: 'backlog-auto-execution',
    title: 'Automated Execution Layer',
    description: 'Connects directly to Fidelity\'s API, executes trades based on your rule set. Includes paper trading validation period and cybersecurity review before any live capital is touched.',
    type: 'feature',
    status: 'backlog',
    owner: 'lori',
    priority: 'low',
  ...
  // ── INVESTOR & FUND INFRASTRUCTURE (Backlog) ──
  {
    id: 'backlog-cash-cycle',
    title: 'Monthly Cash Cycle Tracker',
    description: 'Mirrors Sean\'s end-of-month workflow: dividends received → 30-year treasuries purchased → line of credit deployed → capital redeployed into stocks. Tracks the full cycle in one view.',
    type: 'feature',
    status: 'backlog',
    owner: 'lori',
    priority: 'medium',
  ...
  {
    id: 'backlog-investor-reporting',
    title: 'Investor Reporting Dashboard',
    description: 'Auto-generates monthly performance summaries for LPs — dividend captured, positions held, returns vs. benchmark. Reduces admin overhead as investor count grows.',
    type: 'feature',
    status: 'backlog',
    owner: 'lori',
    priority: 'medium',
  ...
  {
    id: 'backlog-aum-tracker',
    title: 'AUM Growth Tracker',
    description: 'Tracks fundraising pipeline, capital commitments, and projected AUM milestones. Ties directly to the $3M → $5M → $10M growth roadmap.',
    type: 'feature',
    status: 'backlog',
    owner: 'both',
    priority: 'medium',
  ...
  {
    id: 'backlog-capital-allocation',
    title: 'Capital Allocation Optimizer',
    description: 'As AUM grows, models optimal position sizing across the stock universe to maximize dividend capture while managing concentration and liquidity risk.',
    type: 'feature',
    status: 'backlog',
    owner: 'lori',
    priority: 'medium',
  ...
  {
    id: 'backlog-pitch-intelligence',
    title: 'Investor Pitch Intelligence',
    description: 'Pulls in macro data, fund performance, and benchmarks to help frame the fund\'s story for specific investor profiles — useful for Wells Fargo and Schwab conversations.',
    type: 'feature',
    status: 'backlog',
    owner: 'both',
    priority: 'medium',
